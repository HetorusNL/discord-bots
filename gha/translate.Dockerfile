...
# add the translate and wotd bot python files to the docker
COPY poetry.lock /code
COPY pyproject.toml /code
COPY translate-bot/ /code
...
LABEL org.opencontainers.image.description="Translate and word of the day discord bot"
